 ...
 */ var DexSearch = (function () {
  ...
  var _proto = DexSearch.prototype;
  _proto.getTypedSearch = function getTypedSearch(searchType) {
    var format =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
    var speciesOrSet =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
  ...
  _proto.find = function find(query) {
    ...
    this.query = query;
    if (!query) {
      var _this$typedSearch;
      this.results =
        ((_this$typedSearch = this.typedSearch) == null
          ? void 0
          : _this$typedSearch.getResults(
              this.filters,
              this.sortCol,
              this.reverseSort
            )) || [];
  ...
  _proto.setType = function setType(searchType) {
    var _this$typedSearch2;
    var format =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
    var speciesOrSet =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
    ...
    if (
      searchType !==
      ((_this$typedSearch2 = this.typedSearch) == null
        ? void 0
        : _this$typedSearch2.searchType)
    ) {
      this.filters = null;
      this.sortCol = null;
    }
  ...
  _proto.addFilter = function addFilter(entry) {
    ...
    if (this.typedSearch.searchType === "pokemon") {
      ...
      this.results = null;
      for (
        var _i2 = 0, _this$filters2 = this.filters;
        _i2 < _this$filters2.length;
        _i2++
      ) {
        var _filter = _this$filters2[_i2];
  ...
  _proto.removeFilter = function removeFilter(entry) {
  ...
  _proto.toggleSort = function toggleSort(sortCol) {
  ...
  _proto.filterLabel = function filterLabel(filterType) {
    if (this.typedSearch && this.typedSearch.searchType !== filterType) {
      return "Filter";
    }
    return null;
  };
  _proto.illegalLabel = function illegalLabel(id) {
    var _this$typedSearch3, _this$typedSearch3$il;
    return (
      ((_this$typedSearch3 = this.typedSearch) == null
        ? void 0
        : (_this$typedSearch3$il = _this$typedSearch3.illegalReasons) == null
        ? void 0
        : _this$typedSearch3$il[id]) || null
    );
  };
  _proto.getTier = function getTier(species) {
    var _this$typedSearch4;
    return (
      ((_this$typedSearch4 = this.typedSearch) == null
        ? void 0
        : _this$typedSearch4.getTier(species)) || ""
    );
  };
  _proto.textSearch = function textSearch(query) {
    var _this$typedSearch5, _this$typedSearch6;
    query = toID(query);

    this.exactMatch = false;
    var searchType =
      ((_this$typedSearch5 = this.typedSearch) == null
        ? void 0
        : _this$typedSearch5.searchType) || "";
    ...
    var illegal =
      (_this$typedSearch6 = this.typedSearch) == null
        ? void 0
        : _this$typedSearch6.illegalReasons;
    ...
    for (i = 0; i < BattleSearchIndex.length; i++) {
      ...
      if ((_id === "megax" || _id === "megay") && "mega".startsWith(query))
        continue;
      ...
      if (curBufLength && bufs[typeIndex][curBufLength - 1][1] === _id)
        continue;
  ...
  _proto.instafilter = function instafilter(searchType, fType, fId) {
    var _this$typedSearch7;
    var buf = [];
    var illegalBuf = [];
    var illegal =
      (_this$typedSearch7 = this.typedSearch) == null
        ? void 0
        : _this$typedSearch7.illegalReasons;
        ...
        case "type":
          ...
          for (var _id2 in BattlePokedex) {
            ...
            if (this.dex.species.get(_id2).types.includes(type)) {
              (illegal && _id2 in illegal ? illegalBuf : buf).push([
                "pokemon",
                _id2,
              ]);
            }
        ...
        case "ability":
          ...
          for (var _id3 in BattlePokedex) {
            ...
            if (Dex.hasAbility(this.dex.species.get(_id3), ability)) {
              (illegal && _id3 in illegal ? illegalBuf : buf).push([
                "pokemon",
                _id3,
              ]);
            }
        ...
        case "type":
          ...
          for (var _id4 in BattleMovedex) {
            if (BattleMovedex[_id4].type === _type) {
              (illegal && _id4 in illegal ? illegalBuf : buf).push([
                "move",
                _id4,
              ]);
            }
        ...
        case "category":
          ...
          for (var _id5 in BattleMovedex) {
            if (BattleMovedex[_id5].category === category) {
              (illegal && _id5 in illegal ? illegalBuf : buf).push([
                "move",
                _id5,
              ]);
            }
  ...
  DexSearch.getClosest = function getClosest(query) {
    var left = 0;
...
var BattleTypedSearch = (function () {
  function BattleTypedSearch(searchType) {
    var format =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
    var speciesOrSet =
      arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
    this.searchType = void 0;
    this.dex = Dex;
    this.format = "";
    this.species = "";
    this.set = null;
  ...
  var _proto2 = BattleTypedSearch.prototype;
  _proto2.getResults = function getResults(filters, sortCol, reverseSort) {
    var _this = this;
    if (sortCol === "type") {
      return [this.sortRow].concat(
    ...
    if (!this.baseIllegalResults) {
      var legalityFilter = {};
      for (
        var _i4 = 0, _this$baseResults2 = this.baseResults;
        _i4 < _this$baseResults2.length;
        _i4++
      ) {
        var _ref = _this$baseResults2[_i4];
        var resultType = _ref[0];
        var value = _ref[1];
    ...
    if (filters) {
      ...
      illegalResults = [];
      for (
        var _i6 = 0, _this$baseResults4 = this.baseResults;
        _i6 < _this$baseResults4.length;
        _i6++
      ) {
        var result = _this$baseResults4[_i6];
      ...
      for (
        var _i8 = 0, _this$baseIllegalResu2 = this.baseIllegalResults;
        _i8 < _this$baseIllegalResu2.length;
        _i8++
      ) {
        var _result = _this$baseIllegalResu2[_i8];
    ...
    if (sortCol) {
      results = results.filter(function (_ref2) {
        var rowType = _ref2[0];
        return rowType === _this.searchType;
      });
      results = this.sort(results, sortCol, reverseSort);
      if (illegalResults) {
        illegalResults = illegalResults.filter(function (_ref3) {
          var rowType = _ref3[0];
          return rowType === _this.searchType;
        });
    ...
    if (illegalResults && illegalResults.length) {
      results = [].concat(
        results,
        [["header", "Illegal results"]],
        illegalResults
      );
    }
    return results;
  };
  _proto2.firstLearnsetid = function firstLearnsetid(speciesid) {
    var _this$formatType;
    var table = BattleTeambuilderTable;
    if (
      (_this$formatType = this.formatType) != null &&
      _this$formatType.startsWith("bdsp")
    )
  ...
  _proto2.nextLearnsetid = function nextLearnsetid(learnsetid, speciesid) {
    if (
      learnsetid === "lycanrocdusk" ||
      (speciesid === "rockruff" && learnsetid === "rockruff")
    ) {
      return "rockruffdusk";
    }
    ...
    var next =
      lsetSpecies.battleOnly || lsetSpecies.changesFrom || lsetSpecies.prevo;
    if (next) return toID(next);

    return "";
  };
  _proto2.canLearn = function canLearn(speciesid, moveid) {
    ...
    while (learnsetid) {
      var _this$formatType2;
      var table = BattleTeambuilderTable;
      if (
        (_this$formatType2 = this.formatType) != null &&
        _this$formatType2.startsWith("bdsp")
      )
        table = table["gen8bdsp"];
      if (this.formatType === "letsgo") table = table["gen7letsgo"];
      ...
      if (
        learnset &&
        moveid in learnset &&
        (!this.format.startsWith("tradebacks")
  ...
  _proto2.getTier = function getTier(pokemon) {
...
var BattlePokemonSearch = (function (_BattleTypedSearch) {
  _inheritsLoose(BattlePokemonSearch, _BattleTypedSearch);
  function BattlePokemonSearch() {
    ...
    _this2 =
      _BattleTypedSearch.call.apply(_BattleTypedSearch, [this].concat(args)) ||
      this;
    _this2.sortRow = ["sortpokemon", ""];
    return _this2;
  }
  var _proto3 = BattlePokemonSearch.prototype;
  _proto3.getTable = function getTable() {
    return BattlePokedex;
  };
  _proto3.getDefaultResults = function getDefaultResults() {
    var results = [];
  ...
  _proto3.getBaseResults = function getBaseResults() {
    var _this$formatType3,
      _this$formatType4,
      _this$formatType5,
      _this$formatType6;
    ...
    var isVGCOrBS =
      format.startsWith("battlespot") ||
      format.startsWith("battlestadium") ||
      format.startsWith("vgc");
    var isDoublesOrBS =
      isVGCOrBS ||
      ((_this$formatType3 = this.formatType) == null
        ? void 0
        : _this$formatType3.includes("doubles"));
    var dex = this.dex;
    ...
    if ((format.endsWith("cap") || format.endsWith("caplc")) && dex.gen < 9) {
      ...
      (format.includes("doubles") ||
        format.includes("triples") ||
        format === "freeforall" ||
        format.startsWith("ffa") ||
      ...
      (_this$formatType4 = this.formatType) != null &&
      _this$formatType4.startsWith("bdsp")
    ) {
      ...
      (_this$formatType5 = this.formatType) != null &&
      _this$formatType5.startsWith("dlc1")
    ) {
    ...
    if (format === "ubers" || format === "uber")
      ...
      if (format.endsWith("series13")) {
        ...
        format === "vgc2010" ||
        format === "vgc2016" ||
        format.startsWith("vgc2019") ||
        format === "vgc2022" ||
        format.endsWith("series10") ||
        format.endsWith("series11")
      ) {
      ...
      format === "lc" ||
      format === "lcuu" ||
      format.startsWith("lc") ||
      (format !== "caplc" && format.endsWith("lc"))
    )
      tierSet = tierSet.slice(slices.LC);
    else if (format === "cap")
      tierSet = tierSet
        .slice(0, slices.AG || slices.Uber)
        .concat(tierSet.slice(slices.OU));
    else if (format === "caplc") {
      tierSet = tierSet
        .slice(slices["CAP LC"], slices.AG || slices.Uber)
        .concat(tierSet.slice(slices.LC));
    } else if (
      format === "anythinggoes" ||
      format.endsWith("ag") ||
    ...
    } else if (format.includes("hackmons") || format.endsWith("bh"))
      ...
      ((_this$formatType6 = this.formatType) != null &&
        _this$formatType6.startsWith("bdsp")) ||
      this.formatType === "letsgo" ||
      this.formatType === "stadium"
    ) {
      tierSet = tierSet.slice(slices.Uber);
    ...
    if (dex.gen >= 5) {
      if (format === "zu" && table.zuBans) {
        tierSet = tierSet.filter(function (_ref4) {
          var type = _ref4[0],
            id = _ref4[1];
      ...
      if (format === "monotype" && table.monotypeBans) {
        tierSet = tierSet.filter(function (_ref5) {
          var type = _ref5[0],
            id = _ref5[1];
    ...
    if (!/^(battlestadium|vgc|doublesubers)/g.test(format)) {
      tierSet = tierSet.filter(function (_ref6) {
        var type = _ref6[0],
          id = _ref6[1];
  ...
  _proto3.filter = function filter(row, filters) {
    if (!filters) return true;
    if (row[0] !== "pokemon") return true;
    var species = this.dex.species.get(row[1]);
    for (var _i10 = 0; _i10 < filters.length; _i10++) {
      var _ref7 = filters[_i10];
      var filterType = _ref7[0];
      var value = _ref7[1];
      switch (filterType) {
        case "type":
  ...
  _proto3.sort = function sort(results, sortCol, reverseSort) {
    ...
    if (["hp", "atk", "def", "spa", "spd", "spe"].includes(sortCol)) {
      ...
      return results.sort(function (_ref10, _ref11) {
        var rowType1 = _ref10[0],
          id1 = _ref10[1];
        var rowType2 = _ref11[0],
          id2 = _ref11[1];
      ...
      return results.sort(function (_ref12, _ref13) {
        var rowType1 = _ref12[0],
          id1 = _ref12[1];
        var rowType2 = _ref13[0],
          id2 = _ref13[1];
        var name1 = id1;
        var name2 = id2;
...
var BattleAbilitySearch = (function (_BattleTypedSearch2) {
  _inheritsLoose(BattleAbilitySearch, _BattleTypedSearch2);
  function BattleAbilitySearch() {
    return _BattleTypedSearch2.apply(this, arguments) || this;
  }
  var _proto4 = BattleAbilitySearch.prototype;
  _proto4.getTable = function getTable() {
    return BattleAbilities;
  };
  _proto4.getDefaultResults = function getDefaultResults() {
    var results = [];
  ...
  _proto4.getBaseResults = function getBaseResults() {
    ...
    if (isAAA || format.includes("metronomebattle") || isHackmons) {
      ...
      for (
        var _i12 = 0,
          _abilities$sort$map2 = abilities.sort().map(function (abil) {
            return dex.abilities.get(abil);
          });
        _i12 < _abilities$sort$map2.length;
        _i12++
      ) {
        var _ability = _abilities$sort$map2[_i12];
  ...
  _proto4.filter = function filter(row, filters) {
    if (!filters) return true;
    if (row[0] !== "ability") return true;
    var ability = this.dex.abilities.get(row[1]);
    for (var _i14 = 0; _i14 < filters.length; _i14++) {
      var _ref14 = filters[_i14];
      var filterType = _ref14[0];
      var value = _ref14[1];
      switch (filterType) {
        case "pokemon":
  ...
  _proto4.sort = function sort(results, sortCol, reverseSort) {
    throw new Error("invalid sortcol");
  };
  return BattleAbilitySearch;
})(BattleTypedSearch);
var BattleItemSearch = (function (_BattleTypedSearch3) {
  _inheritsLoose(BattleItemSearch, _BattleTypedSearch3);
  function BattleItemSearch() {
    return _BattleTypedSearch3.apply(this, arguments) || this;
  }
  var _proto5 = BattleItemSearch.prototype;
  _proto5.getTable = function getTable() {
    return BattleItems;
  };
  _proto5.getDefaultResults = function getDefaultResults() {
    var _this$formatType7;
    var table = BattleTeambuilderTable;
    if (
      (_this$formatType7 = this.formatType) != null &&
      _this$formatType7.startsWith("bdsp")
    ) {
      table = table["gen8bdsp"];
    } else if (this.formatType === "natdex") {
      table = table["gen" + this.dex.gen + "natdex"];
  ...
  _proto5.getBaseResults = function getBaseResults() {
    if (!this.species) return this.getDefaultResults();
    var speciesName = this.dex.species.get(this.species).name;
    var results = this.getDefaultResults();
    var speciesSpecific = [];
    for (var _i16 = 0; _i16 < results.length; _i16++) {
      var _this$dex$items$get$i;
      var row = results[_i16];
      if (row[0] !== "item") continue;
      if (
        (_this$dex$items$get$i = this.dex.items.get(row[1]).itemUser) != null &&
        _this$dex$items$get$i.includes(speciesName)
      ) {
        speciesSpecific.push(row);
      }
    }
    if (speciesSpecific.length) {
      return [["header", "Specific to " + speciesName]].concat(
        speciesSpecific,
        results
      );
    }
  ...
  _proto5.filter = function filter(row, filters) {
    if (!filters) return true;
    if (row[0] !== "ability") return true;
    var ability = this.dex.abilities.get(row[1]);
    for (var _i18 = 0; _i18 < filters.length; _i18++) {
      var _ref15 = filters[_i18];
      var filterType = _ref15[0];
      var value = _ref15[1];
      switch (filterType) {
        case "pokemon":
          if (!Dex.hasAbility(this.dex.species.get(value), ability.name))
  ...
  _proto5.sort = function sort(results, sortCol, reverseSort) {
    throw new Error("invalid sortcol");
  };
  return BattleItemSearch;
})(BattleTypedSearch);
var BattleMoveSearch = (function (_BattleTypedSearch4) {
  _inheritsLoose(BattleMoveSearch, _BattleTypedSearch4);
  function BattleMoveSearch() {
    ...
    _this4 =
      _BattleTypedSearch4.call.apply(
        _BattleTypedSearch4,
        [this].concat(args)
      ) || this;
    _this4.sortRow = ["sortmove", ""];
    return _this4;
  }
  var _proto6 = BattleMoveSearch.prototype;
  _proto6.getTable = function getTable() {
    return BattleMovedex;
  };
  _proto6.getDefaultResults = function getDefaultResults() {
    var results = [];
  ...
  _proto6.moveIsNotUseless = function moveIsNotUseless(
    id,
    species,
    moves,
    set
  ) {
    var _moveData$flags, _moveData$flags2, _moveData$flags3;
    var dex = this.dex;
    ...
    switch (id) {
      ...
      case "solarblade":
        return (
          [
            ...
            "chlorophyll",
            "orichalcumpulse",
          ].includes(abilityid) || itemid === "powerherb"
        );
      case "dynamicpunch":
      case "grasswhistle":
      case "inferno":
      ...
      case "aerialace":
        return (
          ["technician", "toughclaws"].includes(abilityid) &&
          !moves.includes("bravebird")
        );
      case "ancientpower":
        return (
          ["serenegrace", "technician"].includes(abilityid) ||
          !moves.includes("powergem")
        );
      case "aquajet":
      ...
      case "bellydrum":
        return (
          moves.includes("aquajet") ||
          moves.includes("jetpunch") ||
          moves.includes("extremespeed") ||
      ...
      case "hiddenpowerelectric":
        return (
          dex.gen < 4 &&
          !moves.includes("thunderpunch") &&
          !moves.includes("thunderbolt")
        );
      case "hiddenpowerfighting":
        return (
          dex.gen < 4 &&
          !moves.includes("brickbreak") &&
          !moves.includes("aurasphere") &&
          !moves.includes("focusblast")
        );
      case "hiddenpowerfire":
        return (
          dex.gen < 4 &&
          !moves.includes("firepunch") &&
          !moves.includes("flamethrower") &&
          !moves.includes("mysticalfire") &&
          !moves.includes("burningjealousy")
        );
      case "hiddenpowergrass":
        return (
          !moves.includes("energyball") &&
          !moves.includes("grassknot") &&
          !moves.includes("gigadrain")
        );
      case "hiddenpowerice":
        return (
          (!moves.includes("icebeam") &&
            dex.gen < 4 &&
            !moves.includes("icepunch")) ||
          (dex.gen > 5 &&
            !moves.includes("aurorabeam") &&
            !moves.includes("glaciate"))
        );
      ...
      case "hypnosis":
        return (
          (dex.gen < 4 && !moves.includes("sleeppowder")) ||
          (dex.gen > 6 && abilityid === "baddreams")
        );
      case "icepunch":
        return (
          !moves.includes("icespinner") ||
          ["sheerforce", "ironfist"].includes(abilityid) ||
      ...
      case "icywind":
        return (
          species.baseSpecies === "Keldeo" || this.formatType === "doubles"
        );
      case "infestation":
      ...
      case "irontail":
        return (
          dex.gen > 5 &&
          !moves.includes("ironhead") &&
          !moves.includes("gunkshot") &&
          !moves.includes("poisonjab")
        );
      case "jumpkick":
      ...
      case "nightslash":
        return (
          !moves.includes("crunch") &&
          !(moves.includes("knockoff") && dex.gen >= 6)
        );
      case "outrage":
      ...
      case "phantomforce":
        return (
          (!moves.includes("poltergeist") && !moves.includes("shadowclaw")) ||
          this.formatType === "doubles"
        );
      case "poisonfang":
        return (
          species.types.includes("Poison") &&
          !moves.includes("gunkshot") &&
          !moves.includes("poisonjab")
        );
      case "relicsong":
      ...
      case "technoblast":
        return (
          (dex.gen > 5 && itemid.endsWith("drive")) || itemid === "dousedrive"
        );
      case "teleport":
        return dex.gen > 7;
      case "terrainpulse":
      case "waterpulse":
        return (
          ["megalauncher", "technician"].includes(abilityid) &&
          !moves.includes("originpulse")
        );
      case "toxicspikes":
    ...
    if (
      this.formatType === "doubles" &&
      BattleMoveSearch.GOOD_DOUBLES_MOVES.includes(id)
    ) {
      return true;
    }
    ...
    if (
      (_moveData$flags2 = moveData.flags) != null &&
      _moveData$flags2.recharge
    ) {
      return false;
    }
    if (
      (_moveData$flags3 = moveData.flags) != null &&
      _moveData$flags3.slicing &&
      abilityid === "sharpness"
    ) {
      return true;
    }
  ...
  _proto6.getBaseResults = function getBaseResults() {
    var _this$formatType8, _this$formatType9;
    if (!this.species) return this.getDefaultResults();
    var dex = this.dex;
    var species = dex.species.get(this.species);
    var format = this.format;
    ...
    var regionBornLegality =
      (dex.gen >= 6 && /^battle(spot|stadium|festival)/.test(format)) ||
      format.startsWith("vgc") ||
    ...
    if (
      (_this$formatType8 = this.formatType) != null &&
      _this$formatType8.startsWith("bdsp")
    )
      lsetTable = lsetTable["gen8bdsp"];
    if (this.formatType === "letsgo") lsetTable = lsetTable["gen7letsgo"];
    if (
      (_this$formatType9 = this.formatType) != null &&
      _this$formatType9.startsWith("dlc1")
    )
        ...
        for (var moveid in learnset) {
          ...
          if (
            ...
            (!isTradebacks
              ...
              : !(
                  move.gen <= dex.gen &&
                  learnsetEntry.includes("" + (dex.gen + 1))
                ))
          ) {
            continue;
          }
          ...
          if (
            (_this$formatType10 = this.formatType) != null &&
            _this$formatType10.startsWith("dlc1") &&
            (_BattleTeambuilderTab = BattleTeambuilderTable["gen8dlc1"]) !=
              null &&
            _BattleTeambuilderTab.nonstandardMoves.includes(moveid)
          ) {
            continue;
          }
    ...
    if (sketch || isHackmons) {
      ...
      for (var _id10 in BattleMovedex) {
        if (
          !format.startsWith("cap") &&
          (_id10 === "paleowave" || _id10 === "shadowstrike")
        )
          continue;
        ...
        if (sketch) {
          ...
          if (_move.isNonstandard === "Past" && this.formatType !== "natdex")
            continue;
          sketchMoves.push(_move.id);
        } else {
          if (!(dex.gen < 8 || this.formatType === "natdex") && _move.isZ)
            continue;
          if (typeof _move.isMax === "string") continue;
          if (_move.isMax && dex.gen > 8) continue;
          if (_move.isNonstandard === "Past" && this.formatType !== "natdex")
            continue;
          if (_move.isNonstandard === "LGPE" && this.formatType !== "letsgo")
            continue;
          moves.push(_move.id);
        }
      }
    ...
    if (isSTABmons) {
      for (var _id11 in this.getTable()) {
        ...
        if (
          _move2.isZ ||
          _move2.isMax ||
          (_move2.isNonstandard && _move2.isNonstandard !== "Unobtainable")
        )
          continue;
        ...
        for (var i = dex.gen; i >= species.gen && i >= _move2.gen; i--) {
          ...
          var baseSpecies = genDex.species.get(
          ...
          if (
            ...
            !["Wormadam", "Urshifu"].includes(baseSpecies.baseSpecies)
          ) {
            if (!excludedForme(species))
              speciesTypes.push.apply(speciesTypes, baseSpecies.types);
            for (
              var _i20 = 0, _baseSpecies$otherFor2 = baseSpecies.otherFormes;
              _i20 < _baseSpecies$otherFor2.length;
              _i20++
            ) {
              var formeName = _baseSpecies$otherFor2[_i20];
        ...
        var valid = false;
        for (var _i22 = 0; _i22 < moveTypes.length; _i22++) {
          var type = moveTypes[_i22];
    ...
    var usableMoves = [];
    var uselessMoves = [];
    for (var _i24 = 0, _moves2 = moves; _i24 < _moves2.length; _i24++) {
      var _id12 = _moves2[_i24];
    ...
    for (var _i26 = 0; _i26 < sketchMoves.length; _i26++) {
      var _id13 = sketchMoves[_i26];
      var _isUsable = this.moveIsNotUseless(
        _id13,
        species,
        sketchMoves,
        this.set
  ...
  _proto6.filter = function filter(row, filters) {
    if (!filters) return true;
    if (row[0] !== "move") return true;
    var move = this.dex.moves.get(row[1]);
    for (var _i28 = 0; _i28 < filters.length; _i28++) {
      var _ref16 = filters[_i28];
      var filterType = _ref16[0];
      var value = _ref16[1];
      switch (filterType) {
        case "type":
  ...
  _proto6.sort = function sort(results, sortCol, reverseSort) {
    var _this5 = this;
    var sortOrder = reverseSort ? -1 : 1;
    switch (sortCol) {
      case "power":
        ...
        return results.sort(function (_ref17, _ref18) {
          var rowType1 = _ref17[0],
            id1 = _ref17[1];
          var rowType2 = _ref18[0],
            id2 = _ref18[1];
      ...
      case "accuracy":
        return results.sort(function (_ref19, _ref20) {
          var rowType1 = _ref19[0],
            id1 = _ref19[1];
          var rowType2 = _ref20[0],
            id2 = _ref20[1];
      ...
      case "pp":
        return results.sort(function (_ref21, _ref22) {
          var rowType1 = _ref21[0],
            id1 = _ref21[1];
          var rowType2 = _ref22[0],
            id2 = _ref22[1];
      ...
      case "name":
        return results.sort(function (_ref23, _ref24) {
          var rowType1 = _ref23[0],
            id1 = _ref23[1];
          var rowType2 = _ref24[0],
            id2 = _ref24[1];
          var name1 = id1;
          var name2 = id2;
          return (name1 < name2 ? -1 : name1 > name2 ? 1 : 0) * sortOrder;
...
var BattleCategorySearch = (function (_BattleTypedSearch5) {
  _inheritsLoose(BattleCategorySearch, _BattleTypedSearch5);
  function BattleCategorySearch() {
    return _BattleTypedSearch5.apply(this, arguments) || this;
  }
  var _proto7 = BattleCategorySearch.prototype;
  _proto7.getTable = function getTable() {
    return { physical: 1, special: 1, status: 1 };
  };
  _proto7.getDefaultResults = function getDefaultResults() {
    return [
      ["category", "physical"],
      ["category", "special"],
      ["category", "status"],
  ...
  _proto7.getBaseResults = function getBaseResults() {
    return this.getDefaultResults();
  };
  _proto7.filter = function filter(row, filters) {
    throw new Error("invalid filter");
  };
  _proto7.sort = function sort(results, sortCol, reverseSort) {
    throw new Error("invalid sortcol");
  };
  return BattleCategorySearch;
})(BattleTypedSearch);
var BattleTypeSearch = (function (_BattleTypedSearch6) {
  _inheritsLoose(BattleTypeSearch, _BattleTypedSearch6);
  function BattleTypeSearch() {
    return _BattleTypedSearch6.apply(this, arguments) || this;
  }
  var _proto8 = BattleTypeSearch.prototype;
  _proto8.getTable = function getTable() {
    return window.BattleTypeChart;
  };
  _proto8.getDefaultResults = function getDefaultResults() {
    var results = [];
  ...
  _proto8.getBaseResults = function getBaseResults() {
    return this.getDefaultResults();
  };
  _proto8.filter = function filter(row, filters) {
    throw new Error("invalid filter");
  };
  _proto8.sort = function sort(results, sortCol, reverseSort) {
    throw new Error("invalid sortcol");
  };
